...
//		 	JavaType type = mapper.getTypeFactory().constructParametricType(ArrayList.class, ScansData.class);
//		 	List<ScansData> list =  (List<ScansData>)mapper.readValue(datas, type);
		 	try {
